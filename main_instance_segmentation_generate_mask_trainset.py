...
from trainer.trainer_generate_mask import InstanceSegmentation, RegularCheckpointing
...
@hydra.main(
    config_path="conf", config_name="config_base_instance_segmentation_generate_mask_trainset.yaml"
)
