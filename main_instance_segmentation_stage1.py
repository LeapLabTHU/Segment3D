...
from trainer.trainer_stage1 import InstanceSegmentation, RegularCheckpointing
...
@hydra.main(
    config_path="conf", config_name="config_base_instance_segmentation_stage1.yaml"
)
